package com.ohgiraffer.section03.abstraction;
...
public class Car {
    ...
    public void startUp() {
        if (isOn) {
            ...
            this.isOn = true;   // boolean의 초기값이 false이므로 true로 바꿔주고 시동!
    ...
    public void turnOff() {
        if (isOn) {
            if (speed > 0) {
                ...
                this.isOn = false;   // true = 시동이 켜져 있는 상태이니, false로 바꿔주면서 시동을 끄는거야
