package com.ohgiraffer.section04.constructor;

import org.w3c.dom.ls.LSOutput;

import static jdk.internal.org.jline.utils.InfoCmp.Capability.user3;
...
public class Application {
    public static void main(String[] args) {
         ...
         *  생성자 함수에 매개변수가 없는 생성자를 기본생성자(default constructor)라고 하며,  // package dto에 class MemberDTO -
        ...
        User user3 = new User("user02", "pass02", "이순신");
        System.out.println(user2.getInformation());
    }
