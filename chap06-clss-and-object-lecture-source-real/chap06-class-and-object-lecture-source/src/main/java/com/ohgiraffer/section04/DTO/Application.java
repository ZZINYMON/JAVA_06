package com.ohgiraffer.section04.DTO;

import com.ohgiraffer.section04.constructor.User;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *  단점 : 필드 초기화할 매개변수들을 갯수를 경우의 수 별로 모두 만들어 둬야한다.
        *  호출 시 인자가 많아지는 경우 어떠한 값에 어떤 필드를 의미하는지 한 눈으로 보기 힘들다.
        *  예) 아이디, 비밀번호, 이름이 모두 ohgiraffes인  경우
