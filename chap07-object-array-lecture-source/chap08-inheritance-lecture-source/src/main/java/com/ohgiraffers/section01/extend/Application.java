...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 부모가 가지고 있는 재산(자바에서는 클래스가 가지는 맴버)을 자식이 물려받는다는 의미이다.
         * 클래스 또한 부모클래스와 자식클래스로 역할을 나누어 부모가 가지는 맴버를 자식이 물려받아
         * 자기의 맴버인 것처럼 사용할 수 있도록 만든 기술이다.
         *  */


        /* 하지만 단순 물려받는 개념보다 조금 더 나아간다면
         * 자바에서의 상속은 부모클래스의 확장(extend)의 개념을 가진다.
         * 물려받아서 자신의 것처럼 사용하는 것 뿐 아니라 추가적인 맴버도 작성이 가능하다.
         ...
         * 3. 부모클래스에서 의미 있었던 기능이 자식클래스에서는 무의미할 수 있다.(불필요한 기능이 추가됨)
         *
