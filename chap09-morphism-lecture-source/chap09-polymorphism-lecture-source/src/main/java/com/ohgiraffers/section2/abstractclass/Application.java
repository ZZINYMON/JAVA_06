...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 추상클래스와 추상메소드에 대해 이해할 수 있따.
        * 필기.
        * 추상클래스와 추상메소드
        * 추상메소드를 0개 이상 포함하는 클래스를 추상클래스라고 한다.
        * 추상클래스는 클래스 선언부에 abstract 키워드를 명시하면 추상클래스가 된다.
        * 추상클래스로는 인스턴스(객체)를 생성할 수 없다.
        * 추상클래스를 사용하려면 추상클래스를 상속받은 하위 클래스를 이용해서 인스턴스를 생성해야 하낟.
